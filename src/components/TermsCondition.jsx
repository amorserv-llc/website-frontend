...
export default function () {
  return (
    <>
      ...
      <section className='container terms pt-5'>
        <p>
        These terms and conditions ("Terms") govern your use of the Amorserv Consulting website and services. By accessing our website or engaging our services, you agree to comply with these Terms. Please read them <carefully className="br"></carefully>
...
10. Contact Us: For any questions or concerns regarding these Terms, please contact us. <br />
